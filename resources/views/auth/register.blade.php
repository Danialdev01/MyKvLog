...
<head>
    ...
    <title>Daftar - MyInternLog</title>
    ...
    <div class="register-box">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Nama penuh anda" required autofocus autocomplete="name" />
            </div>

            <div class="form-group">
                <label for="email">Alamat Emel</label>
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="anda@contoh.com" required autocomplete="username" />
            </div>

            <div class="form-group">
                <label for="password">Kata Laluan</label>
                <input type="password" id="password" name="password" placeholder="Buat kata laluan" required autocomplete="new-password" />
            </div>

            <div class="form-group">
                <label for="password_confirmation">Sahkan Kata Laluan</label>
                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Sahkan kata laluan anda" required autocomplete="new-password" />
            </div>
        ...
        <div class="form-footer">
            Sudah ada akaun? <a href="{{ route('login') }}">Daftar masuk</a>
        </div>
    </div>
</body>
</html>